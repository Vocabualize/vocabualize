  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog.adaptive(
      ...
      contentPadding: EdgeInsets.only(
        ...
        bottom: widget.editTarget ? Dimensions.smallSpacing : Dimensions.semiSmallSpacing,
      ),
      content: SizedBox(
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      label: Text(
                        widget.editTarget
                            ? context.s.details_target_input_label
                            : context.s.details_source_input_label,
                      ),
                    ),
                  ),
                ),
...
class _ReportTranslationButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TextButton(
      ...
      child: Text(
        context.s.details_report_faulty_translation,
