...
class _ReportScreenState extends ConsumerState<ReportScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          isTranslation ? context.s.report_translation_title : context.s.report_bug_title,
        ),
      ),
      body: ListView(
        shrinkWrap: true,
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              label: Text(
                isTranslation
                    ? context.s.report_translation_note_hint
                    : context.s.report_bug_description_hint,
              ),
            ),
          ),
          const SizedBox(height: Dimensions.mediumSpacing),
          ElevatedButton(
            ...
            child: Text(context.s.common_submit),
          ),
        ],
      ),
    );
